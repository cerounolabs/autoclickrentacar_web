...
function selectVehiculo(val){
	var inputID 	= document.getElementById('rsv07');
	var elemID 		= document.getElementById(val.substring(0, 5));
	var radioID 	= document.getElementById(val);
	var formID 		= document.getElementById('form02');
	var formCLASS	= formID.getElementsByClassName('vehicle-section clearfix');
	var buttonID 	= document.getElementById('btn-02');

	for (i = 0; i < formCLASS.length; i++) {
        formCLASS[i].className = 'vehicle-section clearfix';
    }
	
	elemID.className		= 'vehicle-section clearfix vehicle-section_selected';
	inputID.value 			= radioID.value;
	buttonID.disabled 		= false;
	buttonID.style.display 	= 'inline-table';
}